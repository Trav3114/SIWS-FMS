	...
	<div class="col-md-4">
		<div class="panel panel-primary" style="margin-top:20%;">
			...
			<div class="panel-body">
				<h4>Student ID: <label class="pull-right"><?php echo $fetch['stud_no']?></label></h4>
				<hr style="border-top:1px dotted #ccc;"/>
				<h4>Roll no: <label class="pull-right"><?php echo $fetch['roll_no']?></label></h4>
				<hr style="border-top:1px dotted #ccc;"/>
				...
				<hr style="border-top:1px dotted #ccc;"/>
				<h4>Year & Dept: <label class="pull-right"><?php echo $fetch['yr&sec']?></label></h4>
				<hr style="border-top:1px dotted #ccc;"/>
				<h3>File</h3>
